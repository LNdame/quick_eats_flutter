...
class _$Menu extends Menu {
  ...
  @override
  final BuiltList<MenuItem> menu_items;
...
class MenuBuilder implements Builder<Menu, MenuBuilder> {
  ...
  ListBuilder<MenuItem> _menu_items;
  ListBuilder<MenuItem> get menu_items =>
      _$this._menu_items ??= new ListBuilder<MenuItem>();
  set menu_items(ListBuilder<MenuItem> menu_items) =>
